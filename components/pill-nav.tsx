...
const PillNav = ({
    ...
    useEffect(() => {
        ...
        setTimeout(layout, 100) // Small delay for layout stability
    ...
    return (
        <div className="absolute top-[1em] z-[1000] w-full left-0 md:w-auto md:left-auto">
            ...
            >
                ...
                >
                    {/* Logo - Assuming string source or handling Next Image if passed as object */}
                    <Image
                        src={logo}
                        alt={logoAlt}
                        width={36}
                ...
                {/* Helper for right content to align */}
